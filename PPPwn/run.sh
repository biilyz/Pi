...
if [ $ret -ge 1 ]
   then
		...
		if [ $PPPOECONN = true ] ; then
			...
			sudo iptables -t nat -I PREROUTING -p tcp --dport 1024:65535 -j DNAT --to 192.168.2.2:1024-65535
			sudo iptables -t nat -I PREROUTING -p udp --dport 1024:65535 -j DNAT --to 192.168.2.2:1024-65535
